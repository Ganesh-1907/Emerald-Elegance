...
export const siteConfig = {
  ...
  ogImage: import.meta.env.VITE_OG_IMAGE?.trim() || `${resolvedSiteUrl}/opengraph.jpg`,
...
export const sitePages: SitePageConfig[] = [
  ...
  },
  {
    ...
    description:
      "Read the Moto Node privacy policy to understand how we collect, use, and protect information across our automobile platform and services.",
    keywords: ["Moto Node privacy", "privacy policy", "data protection", "user privacy"],
    changefreq: "yearly",
    priority: "0.5",
    indexable: true,
  },
