      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
              {[Twitter, Instagram, Facebook, Youtube].map((Icon, i) => (
                <a key={i} href="#" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-muted-foreground hover:bg-primary/20 hover:text-primary transition-all hover:-translate-y-1">
          ...
          <div>
            ...
            <ul className="space-y-4">
              {["About Us", "Become a Dealer", "Careers", "Privacy Policy", "Terms of Service"].map((item) => (
                <li key={item}>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3 text-muted-foreground text-sm">
                ...
                <span>support@carconnect.tech</span>
              </li>
            </ul>
          </div>
        </div>
